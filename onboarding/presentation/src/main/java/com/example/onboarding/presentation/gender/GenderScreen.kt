...
import com.example.onboarding.presentation.components.ActionButton
import com.example.onboarding.presentation.components.SelectableButton

@Composable
fun GenderScreen(
    onNavigate: (UiEvent.Navigate) -> Unit,
    viewModel: GenderScreenViewModel = hiltViewModel()
) {
