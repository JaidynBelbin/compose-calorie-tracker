...
import androidx.compose.ui.unit.dp
import com.example.core_ui.components.SegmentedButtonsDefaults.ITEM_ANIMATION_MILLIS
import com.example.core_ui.components.SegmentedButtonsDefaults.minimumHeight
import com.example.core_ui.components.SegmentedButtonsDefaults.outlineThickness
...
object SegmentedButtonsDefaults {
    ...
    fun colors(
        ...
        unselectedTextColor: Color = MaterialTheme.colors.onSurface,
        unselectedIconColor: Color = MaterialTheme.colors.onSurface,
        indicatorColor: Color = MaterialTheme.colors.secondary,
        outlineColor: Color = MaterialTheme.colors.secondaryVariant
